<%-- Document : info_account Created on : Jun 22, 2025, 10:35:10 PM Author :
            ...
            <div class="user-info-card">
              ...
              <div class="d-flex align-items-center mb-3">
                <div class="user-avatar">
                  ${fn:toUpperCase( fn:substring(
                  fn:split(sessionScope.user.full_name, '
                  ')[fn:length(fn:split(sessionScope.user.full_name, ' ')) - 1],
                  0, 1 ) )}
                </div>
                <div class="ms-3">
